  ...
  'node_modules/node-fetch/lib/index.js'(exports2, module2) {
    ...
    function getTotalBytes(instance) {
      ...
      if (body2 === null) {
        ...
        if (
          (body2._lengthRetrievers && body2._lengthRetrievers.length == 0) ||
...
var require_rest = __commonJS({
  'node_modules/@octokit/rest/index.js'(exports2, module2) {
    ...
    var { restEndpointMethods } = require_dist_node8();
...
var { GitHub, context } = require_github();
var fs = require('fs');
